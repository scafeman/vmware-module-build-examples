...
- `main.tf`: This file defines the `vcd_nsxt_security_group` module that creates the NSX-T Security Groups.
...
3. Navigate to the `vcd_nsxt_security_group` directory.
...
If you have an example of how to use the `vcd_nsxt_security_group` module to create NSX-T Security Groups in a different environment or with different settings, we welcome your contributions. Please fork this repository, create a new directory for your example, and submit a pull request.

...
- `main.tf`: This file defines the `vcd_nsxt_firewall` module that creates the NSX-T Edge Gateway Firewall Rules.
...
3. Navigate to the `vcd_nsxt_firewall` directory.
...
If you have an example of how to use the `vcd_nsxt_firewall` module to create NSX-T Edge Gateway Firewall Rules in a different environment or with different settings, we welcome your contributions. Please fork this repository, create a new directory for your example, and submit a pull request.

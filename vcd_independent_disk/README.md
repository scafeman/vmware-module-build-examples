# VMware Cloud Director Independent Disk Terraform Build Example

This directory contains an example Terraform configuration that demonstrates how to use the [vcd_independent_disk](https://github.com/global-vmware/vcd_independent_disk) Terraform Module to deploy Named Disks into the [Rackspace SDDC Flex](https://www.rackspace.com/cloud/private/software-defined-data-center-flex) VMware Cloud Director Platform.

## Overview

The Terraform configuration consists of four files:

- `main.tf`: This file defines the `vcd_independent_disk` module that creates the Named Disks.
...
3. Navigate to the `vcd_independent_disk` directory.
...
If you have an example of how to use the `vcd_independent_disk` module to create Independent Disks in a different environment or with different settings, we welcome your contributions. Please fork this repository, create a new directory for your example, and submit a pull request.

...
This directory contains an example Terraform configuration that demonstrates how to use the [vcd_nsxt_distributed_firewall](https://github.com/global-vmware/vcd_nsxt_distributed_firewall) Terraform Module to deploy NSX-T Distributed Firewall Rules into the [Rackspace SDDC Flex](https://www.rackspace.com/cloud/private/software-defined-data-center-flex) VMware Cloud Director Platform.

## Overview

The Terraform configuration consists of four files:

- `main.tf`: This file defines the `vcd_nsxt_distributed_firewall` module that creates the NSX-T Distributed Firewall Rules.
...
3. Navigate to the `vcd_nsxt_distributed_firewall` directory.
...
If you have an example of how to use the `vcd_nsxt_distributed_firewall` module to create NSX-T Distributed Firewall Rules in a different environment or with different settings, we welcome your contributions. Please fork this repository, create a new directory for your example, and submit a pull request.

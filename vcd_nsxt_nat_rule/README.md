...
- `main.tf`: This file defines the `vcd_nsxt_nat_rule` module that creates NSX-T NAT Rules.
...
If you have an example of how to use the `vcd_nsxt_nat_rule` module to create NSX-T NAT Rules in a different environment or with different settings, we welcome your contributions. Please fork this repository, create a new directory for your example, and submit a pull request.
